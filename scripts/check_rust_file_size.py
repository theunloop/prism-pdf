...
EXCEPTIONS = {
    ...
    "crates/pdf-ffi/src/api/security.rs": (
        ...
        "their metadata into the graphic itself. +4 the same day rejecting a non-finite size or "
        "leading, which would otherwise reach a signed appearance stream as `inf Tf`.",
    ),
    "crates/pdf-ffi/src/api/tests.rs": (
        ...
        "null-handle paths, +34 the same day for the sizes and leadings those setters now "
        "refuse.",
    ),
